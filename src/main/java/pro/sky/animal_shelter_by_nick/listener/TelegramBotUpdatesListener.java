package pro.sky.animal_shelter_by_nick.listener;
...
import pro.sky.animal_shelter_by_nick.keyboard.KeyBoardShelter;
...
import pro.sky.animal_shelter_by_nick.service.ReportDataService;
...
/**
 * Сервси для обработки сообщений пользователя
 */
@Service
public class TelegramBotUpdatesListener implements UpdatesListener {
    ...
    private static final String infoAboutBot = "Информация о возможностях бота \n- Бот может показать информацию о приюте \n" +
            ...
            "";
    private static final String infoAboutShelterDog = "Наш сайт с информацией о приюте для собак \nhttps://take_a_dog.com \n" +
            "Контактные данные \n Вставьте ваш номер телефона\n" +
            "Общие рекомендации \n Вставьте ваши рекомендации\n" +
            "";
    private static final String infoAboutShelterCat = "Наш сайт с информацией о приюте для кошек \nhttps://take_a_cat.com \n" +
            "Контактные данные \n Вставьте ваш номер телефона\n" +
            "Общие рекомендации \n Вставьте ваши рекомендации\n" +
            "";
    private static final String infoAboutDogs = "Правила знакомства с животным \nВставьте ваши правила\n" +
            "Список документов \nВставьте список документов\n" +
            "Список рекомендаций \nВставьте список рекомендаций\n" +
            "Советы кинолога \nВставьте рекомендации кинолога\n" +
            "Прочая информация \nВставьте прочую информацию\n" +
            "";

    private static final String infoAboutCats = "Правила знакомства с животным \nВставьте список правил\n" +
            "Список документов \nВставьте список документов\n" +
            "Список рекомендаций \nВставьте список рекомендаций\n" +
            "Прочая информация \nВставьте прочую информацию\n" +
            "";
    private static final String infoContactsVolunteer = "Контактные данные волонтера  \n@NikitaShkril \n" +
